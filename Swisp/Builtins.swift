...
extension LispRuntime {
    func setupBuiltins() {
        define(name:"+",args:(.param,2,2),
               params:"(x y)",
               descr:"") { args,_,_ in
            return try Number(num: args[0].num + args[1].num)
        }
        define(name:"-",args:(.optional,1,2),
               params:"(x y)",
               descr:""
               ) { args,_,_ in
        ...
        define(name:"getprop",args:(.param,2,2),
               params:"(atm prop)",
               descr:"") { args,env,_ in
        ...
        define(name:"quote",args:(.param,1,1),special:true,
               params:"(expr)",
               descr:"") { args,_,_ in
            return args[0]
        }
        define(name:"rplaca",args:(.param,2,2),
               params:"(atm value)",
               descr:"") { args,_,_ in
        ...
        define(name:"rplacd",args:(.param,2,2),
               params:"(atm value)",
               descr:"") { args,_,_ in
        ...
        define(name:"progn",args:(.rest,0,0),
               params:"(expr1 expr2 ... exprn)",
               descr:"") { args,env,tail in
            return args.last ?? env.NIL
        }
        define(name:"print",args:(.rest,0,0),
               params:"(expr1 expr2 ... exprn)",
               descr:"") { args,env,tail in
            var sp = ""
            for e in args {
        ...
        define(name:"unstr",args:(.param,1,1),
               params:"(str)",
               descr:"") { args,env,tail in
        ...
        define(name:"eval",args:(.param,1,1),
               params:"(expr)",
               descr:"") { args,env,tail in
            return try args[0].eval(env,nil)
        }
        define(name:"setq",args:(.rest,2,2),special:true,
               params:"(atm expr ...)",
               descr:"") { args,env,_ in
            var r: Expr = env.NIL
        ...
        define(name:"funset",args:(.param,2,2),
               params:"(atm fun)",
               descr:"") { args,env,_ in
        ...
        define(name:"list",args:(.rest,0,0),
               params:"(expr1 expr2 ... exprn)",
               descr:"") { args,env,tail in
            return try env.lisp.arrayToList(args)
        }
        define(name:"if",args:(.optional,2,3),special:true,
               params:"(test then &optional else)",
               descr:"") { args,env,tail in
            if args.count > 2 {
        ...
        define(name:"or",args:(.param,2,2),special:true,
               params:"(a b)",
               descr:"") { args,env,tail in
        ...
        define(name:"and",args:(.param,2,2),special:true,
               params:"(a b)",
               descr:"") { args,env,tail in
        ...
        define(name:"strformat",args:(.optional,1,100),
               params:"(fmt expr1 ...)",
               descr:"") { args,env,tail in
        ...
        define(name:"read",args:(.optional,0,1),
               params:"(&optional stream)",
               descr:"") { args,env,tail in
        ...
        define(name:"peekchar",args:(.param,1,1),
               params:"(stream)",
               descr:"") { args,env,tail in
        ...
        define(name:"skipchar",args:(.param,1,1),
               params:"(stream)",
               descr:"") { args,env,tail in
        ...
        define(name:"flush",args:(.optional,0,1),
               params:"(&optional stream)",
               descr:"") { args,env,tail in // TBD
        ...
        define(name:"readfile",args:(.param,1,1),
               params:"(stream)",
               descr:"") { args,env,tail in
        ...
        define(name:"readmacro",args:(.param,2,2),
               params:"(stream fun)",
               descr:"") { args,env,tail in
        ...
        define(name:"defun",args:(.rest,2,100),special:true,
               params:"(name (param ..) .body)",
               descr:"") { args,env,tail in
            ...
            let lambda = Cons(car: env.lisp.LAMBDA,
        ...
        define(name:"defmacro",args:(.rest,2,100),special:true,
               params:"(name (param ..) .body)",
               descr:"") { args,env,tail in
        ...
        define(name:"while",args:(.rest,1,100),special:true,
               params:"(test .body)",
               descr:"") { args,env,tail in
            let NIL = env.NIL
            let test = args[0]
        ...
        define(name:"cond",args:(.rest,1,100),special:true,
               params:"((test1 . body1) ... (testn .bodyn))",
               descr:"") { args,env,tail in
            let NIL = env.NIL
            for e in args {
                if let c = e as? Cons {
        ...
        define(name:"catch",args:(.param,2,2),special:true,
               params:"(tag expr)",
               descr:"") { args,env,tail in
        ...
        define(name:"throw",args:(.param,2,2),
               params:"(tag expr)",
               descr:"") { args,env,tail in
            throw LispError.user("throw",args[0] as! Atom,args[1])
        }
        define(name:"gensym",args:(.param,0,0),
               params:"(expr1 expr2 ... exprn)",
               descr:"") { args,env,tail in
            return Atom(name:"<gensym\(Int.random(in: 10000000..<99999999))>")
        }
        define(name:"clock",args:(.param,0,0),
               params:"()",
               descr:"") { args,env,tail in
            let date = Date()
            return Number(num:Int(date.timeIntervalSince1970 * 1000))
        }
        define(name:"function",args:(.param,1,1),
               params:"(expr)",
               descr:"") { args,env,tail in
            let e = args[0]
            if let c = e as? Cons, c.carValue.isEq(env.lisp.LAMBDA) { // return e.eval(env) ?
        ...
        define(name:"ismacro",args:(.param,1,1),
               params:"(expr)",
               descr:"") { args,env,tail in
            guard let f = args[0] as? Func else { return env.NIL }
            return f.ftype == .macro ? env.TRUE :  env.NIL
        }
        define(name:"isspecial",args:(.param,1,1),
               params:"(expr)",
               descr:"") { args,env,tail in
            guard let f = args[0] as? Func else { return env.NIL }
            return f.special ? env.TRUE : env.NIL
        }
        define(name:"isbuiltin",args:(.param,1,1),
               params:"(expr)",
               descr:"") { args,env,tail in
            guard let f = args[0] as? Func else { return env.NIL }
            return f.ftype == .builtin ? env.TRUE : env.NIL
        }
        define(name:"funcall",args:(.rest,1,1),special:true,
               params:"fun (expr1 expr2 ... exprn)",
               descr:"") { args,env,tail in
        ...
        define(name:"apply",args:(.param,2,2),
               params:"(fun args)",
               descr:"") { args,env,tail in
        ...
        define(name:"lambda",args:(.rest,1,100),special:true,
               params:"((param ..) .body)",
               descr:"",
               fun:lambda)
        define(name:"fn",args:(.rest,1,100),special:true,
               params:"((param ..) .body)",
               descr:"",
               fun:lambda)
        define(name:"nlambda",args:(.rest,1,100),special:true,
               params:"((param ..) .body)",
               descr:"") { args,env,tail in
        ...
        define(name:"macro",args:(.rest,1,100),special:true,
               params:"((param ..) .body)",
               descr:"") { args,env,tail in
            let nl = try lambda(args,env,tail:tail)
            nl.special = true
        ...
        define(name:"let*",args:(.rest,1,100),special:true,
               params:"((var1 expr1) ... (varn exprn))",
               descr:"") { args,env,tail in
        ...
        define(name:"flet",args:(.rest,1,100),special:true,
               params:"((var1 (param1 ...) . body1) ... (varn (paramn ...) .bodyn))",
               descr:"") { args,env,tail in // (flet ((f params .body)...(...)) . body)
            env.push()
            for p in args[0] as! Cons {
        ...
        define(name:"symbol-table",args:(.param,0,0),special:true,
               params:"()",
               descr:"") { args,env,tail in
        ...
        define(name:"unclosure",args:(.param,1,1),special:true,
               params:"(atm)",
               descr:"") { args,env,_ in
        ...
        define(name:"arglist",args:(.param,1,1),
               params:"(fun)",
               descr:"") { args,env,_ in
            guard let f = args[0] as? Func else { return env.NIL }
            return f.params == nil ? Str(str:"()") : Str(str:f.params!)
        }
    }
}
